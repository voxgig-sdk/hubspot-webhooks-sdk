...
func NewBasicEntity(client *core.HubspotWebhooksSDK, entopts map[string]any) *BasicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BasicEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BasicLoadMatch and returns an Basic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BasicEntity) LoadTyped(reqmatch BasicLoadMatch, ctrl map[string]any) (Basic, error) {
