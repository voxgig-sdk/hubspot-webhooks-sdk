...
const testSeed = `map[string]any{"entity": map[string]any{"basic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_batch_response_journal_fetch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_batch_response_subscription": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_collection_response_subscription_response_no_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_crm_object_snapshot_batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_filter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_snapshot_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_subscription": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_subscription_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhooks_subscription_response_1": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
