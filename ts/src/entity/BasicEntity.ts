...
class BasicEntity extends HubspotWebhooksEntityBase<Basic> {
  ...
  async load(this: any, reqmatch?: BasicLoadMatch, ctrl?: Control): Promise<BasicEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Basic> return stays clean under strict null checks.
