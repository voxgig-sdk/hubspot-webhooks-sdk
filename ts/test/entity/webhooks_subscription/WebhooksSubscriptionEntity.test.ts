...
describe('WebhooksSubscriptionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.live) {
      return runLiveEntity(setup, {"active":true,"alias":{"field":{}},"fields":[{"active":true,"name":"active","op":{"update":{"req":false,"type":"`$BOOLEAN`"}},"req":true,"short":"A boolean indicating whether the subscription is currently active.","type":"`$BOOLEAN`","index$":0},{"active":true,"format":"date-time","name":"createdAt","req":true,"short":"The date and time when the subscription was created, in ISO 8601 format.","type":"`$STRING`","index$":1},{"active":true,"name":"eventType","req":true,"short":"The type of event that triggers the subscription.","type":"`$STRING`","index$":2},{"active":true,"name":"eventTypeName","req":false,"short":"The name of the event type for the subscription.","type":"`$STRING`","index$":3},{"active":true,"name":"id","req":true,"short":"The unique identifier for the subscription.","type":"`$STRING`","index$":4},{"active":true,"name":"objectTypeId","req":false,"short":"The identifier for the object type associated with the subscription.","type":"`$STRING`","index$":5},{"active":true,"name":"propertyName","req":false,"short":"The name of the property associated with the subscription event, if applicable.","type":"`$STRING`","index$":6},{"active":true,"format":"date-time","name":"updatedAt","req":false,"short":"The date and time when the subscription was last updated, in ISO 8601 format.","type":"`$STRING`","index$":7}],"id":{"field":"id","name":"id"},"name":"webhooks_subscription","op":{"create":{"input":"data","name":"create","points":[{"active":true,"args":{"params":[{"active":true,"example":null,"kind":"param","name":"app_id","orig":"app_id","reqd":true,"type":"`$INTEGER`","index$":0}]},"contract":{"id":"POST /app-webhooks/2026-09/{appId}/subscriptions","json":"{\"operationId\":\"post-/app-webhooks/2026-09/{appId}/subscriptions_create\",\"parameters\":[{\"description\":\"The unique identifier of the app for which the webhook subscription is being created.\",\"explode\":false,\"in\":\"path\",\"name\":\"appId\",\"required\":true,\"schema\":{\"example\":null,\"format\":\"int32\",\"type\":\"integer\"},\"style\":\"simple\"}],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"example\":null,\"schema\":{\"example\":null,\"properties\":{\"active\":{\"description\":\"A boolean indicating whether the subscription is active.\",\"example\":null,\"type\":\"boolean\"},\"eventType\":{\"description\":\"A string representing the type of event to subscribe to. Valid values include various property changes, creations, deletions, merges, restorations, association changes, and event completions.\",\"enum\":[\"company.associationChange\",\"company.creation\",\"company.deletion\",\"company.merge\",\"company.propertyChange\",\"company.restore\",\"contact.associationChange\",\"contact.creation\",\"contact.deletion\",\"contact.merge\",\"contact.privacyDeletion\",\"contact.propertyChange\",\"contact.restore\",\"conversation.creation\",\"conversation.deletion\",\"conversation.newMessage\",\"conversation.privacyDeletion\",\"conversation.propertyChange\",\"deal.associationChange\",\"deal.creation\",\"deal.deletion\",\"deal.merge\",\"deal.propertyChange\",\"deal.restore\",\"event.completed\",\"line_item.associationChange\",\"line_item.creation\",\"line_item.deletion\",\"line_item.merge\",\"line_item.propertyChange\",\"line_item.restore\",\"object.associationChange\",\"object.creation\",\"object.deletion\",\"object.merge\",\"object.propertyChange\",\"object.restore\",\"product.creation\",\"product.deletion\",\"product.merge\",\"product.propertyChange\",\"product.restore\",\"ticket.associationChange\",\"ticket.creation\",\"ticket.deletion\",\"ticket.merge\",\"ticket.propertyChange\",\"ticket.restore\"],\"example\":null,\"type\":\"string\"},\"eventTypeName\":{\"description\":\"A string providing a human-readable name for the event type.\",\"example\":null,\"type\":\"string\"},\"objectTypeId\":{\"description\":\"A string representing the ID of the object type associated with the subscription.\",\"example\":null,\"type\":\"string\"},\"propertyName\":{\"description\":\"A string indicating the specific property name related to the event type, if applicable.\",\"example\":null,\"type\":\"string\"}},\"required\":[\"active\",\"eventType\"],\"type\":\"object\"}}},\"required\":true},\"responses\":{\"201\":{\"content\":{\"application/json\":{\"example\":null,\"schema\":{\"example\":null,\"properties\":{\"active\":{\"description\":\"A boolean indicating whether the subscription is currently active.\",\"example\":null,\"type\":\"boolean\"},\"createdAt\":{\"description\":\"The date and time when the subscription was created, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"},\"eventType\":{\"description\":\"The type of event that triggers the subscription. Valid values include various property changes, creations, deletions, merges, restores, and association changes for different HubSpot objects.\",\"enum\":[\"company.associationChange\",\"company.creation\",\"company.deletion\",\"company.merge\",\"company.propertyChange\",\"company.restore\",\"contact.associationChange\",\"contact.creation\",\"contact.deletion\",\"contact.merge\",\"contact.privacyDeletion\",\"contact.propertyChange\",\"contact.restore\",\"conversation.creation\",\"conversation.deletion\",\"conversation.newMessage\",\"conversation.privacyDeletion\",\"conversation.propertyChange\",\"deal.associationChange\",\"deal.creation\",\"deal.deletion\",\"deal.merge\",\"deal.propertyChange\",\"deal.restore\",\"event.completed\",\"line_item.associationChange\",\"line_item.creation\",\"line_item.deletion\",\"line_item.merge\",\"line_item.propertyChange\",\"line_item.restore\",\"object.associationChange\",\"object.creation\",\"object.deletion\",\"object.merge\",\"object.propertyChange\",\"object.restore\",\"product.creation\",\"product.deletion\",\"product.merge\",\"product.propertyChange\",\"product.restore\",\"ticket.associationChange\",\"ticket.creation\",\"ticket.deletion\",\"ticket.merge\",\"ticket.propertyChange\",\"ticket.restore\"],\"example\":null,\"type\":\"string\"},\"eventTypeName\":{\"description\":\"The name of the event type for the subscription.\",\"example\":null,\"type\":\"string\"},\"id\":{\"description\":\"The unique identifier for the subscription. It is an integer formatted as int64.\",\"example\":null,\"type\":\"string\"},\"objectTypeId\":{\"description\":\"The identifier for the object type associated with the subscription. It is a string.\",\"example\":null,\"type\":\"string\"},\"propertyName\":{\"description\":\"The name of the property associated with the subscription event, if applicable.\",\"example\":null,\"type\":\"string\"},\"updatedAt\":{\"description\":\"The date and time when the subscription was last updated, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"}},\"required\":[\"active\",\"createdAt\",\"eventType\",\"id\"],\"type\":\"object\"}}},\"description\":\"successful operation\",\"headers\":{\"Location\":{\"description\":\"URL of the newly created resource\",\"explode\":false,\"schema\":{\"example\":null,\"type\":\"string\"},\"style\":\"simple\"}}},\"default\":{\"content\":{\"*/*\":{\"example\":null,\"schema\":{\"description\":\"Represents an error response returned by the API when an operation fails. This component is used in various endpoints to provide detailed information about the error encountered.\",\"example\":{\"category\":\"VALIDATION_ERROR\",\"correlationId\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"links\":{\"knowledge-base\":\"https://www.hubspot.com/products/service/knowledge-base\"},\"message\":\"Invalid input (details will vary based on the error)\"},\"properties\":{\"category\":{\"description\":\"The error category\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{invalidPropertyName=[propertyValue], missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"correlationId\":{\"description\":\"A unique identifier for the request. Include this value with any error reports or support tickets\",\"example\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"format\":\"uuid\",\"type\":\"string\"},\"errors\":{\"description\":\"further information about the error\",\"example\":null,\"items\":{\"description\":\"Represents detailed information about an error that occurred in the API. This component is used to provide additional context and specifics about errors, typically as part of an error response.\",\"example\":null,\"properties\":{\"code\":{\"description\":\"The status code associated with the error detail\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"in\":{\"description\":\"The name of the field or parameter in which the error was found.\",\"example\":null,\"type\":\"string\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":null,\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"message\"],\"type\":\"object\"},\"type\":\"array\"},\"links\":{\"additionalProperties\":{\"example\":null,\"type\":\"string\"},\"description\":\"A map of link names to associated URIs containing documentation about the error or recommended remediation steps\",\"example\":null,\"type\":\"object\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":\"An error occurred\",\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"category\",\"correlationId\",\"message\"],\"type\":\"object\"}}},\"description\":\"\"}},\"security\":[{\"oauth2\":[\"developers-write\"]},{\"oauth2\":[\"private-apps-write\"]}],\"securitySchemes\":{\"developer_hapikey\":{\"in\":\"query\",\"name\":\"hapikey\",\"type\":\"apiKey\"},\"oauth2\":{\"flows\":{\"authorizationCode\":{\"authorizationUrl\":\"https://app.hubspot.com/oauth/authorize\",\"scopes\":{\"developers-read\":\"\",\"developers-write\":\"\",\"private-apps-read\":\"\",\"private-apps-write\":\"\",\"webhooks-journal-data-access\":\"\",\"webhooks-journal-snapshot-management\":\"\",\"webhooks-journal-subscription-management\":\"\",\"webhooks-journal-subscription-read\":\"\"},\"tokenUrl\":\"https://api.hubapi.com/oauth/v1/token\"}},\"type\":\"oauth2\"},\"private_apps\":{\"in\":\"header\",\"name\":\"private-app\",\"type\":\"apiKey\"},\"private_apps_legacy\":{\"in\":\"header\",\"name\":\"private-app-legacy\",\"type\":\"apiKey\"}},\"securitySource\":\"operation\"}","source":"openapi3","version":1},"kind":"http","method":"POST","orig":"/app-webhooks/2026-09/{appId}/subscriptions","rename":{"param":{"appId":"app_id"}},"segments":[{"lit":"app-webhooks"},{"lit":"2026-09"},{"var":"app_id"},{"lit":"subscriptions"}],"select":{"exist":["app_id"]},"transform":{"req":"`reqdata`","res":"`body`"},"index$":0}],"key$":"create"},"load":{"input":"data","name":"load","points":[{"active":true,"args":{"params":[{"active":true,"example":null,"kind":"param","name":"app_id","orig":"app_id","reqd":true,"type":"`$INTEGER`","index$":0},{"active":true,"example":null,"kind":"param","name":"id","orig":"subscription_id","reqd":true,"type":"`$INTEGER`","index$":1}]},"contract":{"id":"GET /app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}","json":"{\"operationId\":\"get-/app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}_getById\",\"parameters\":[{\"description\":\"The unique identifier of the app for which the subscription is configured.\",\"explode\":false,\"in\":\"path\",\"name\":\"appId\",\"required\":true,\"schema\":{\"example\":null,\"format\":\"int32\",\"type\":\"integer\"},\"style\":\"simple\"},{\"description\":\"The unique identifier of the subscription to retrieve.\",\"explode\":false,\"in\":\"path\",\"name\":\"subscriptionId\",\"required\":true,\"schema\":{\"example\":null,\"format\":\"int32\",\"type\":\"integer\"},\"style\":\"simple\"}],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"example\":null,\"schema\":{\"example\":null,\"properties\":{\"active\":{\"description\":\"A boolean indicating whether the subscription is currently active.\",\"example\":null,\"type\":\"boolean\"},\"createdAt\":{\"description\":\"The date and time when the subscription was created, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"},\"eventType\":{\"description\":\"The type of event that triggers the subscription. Valid values include various property changes, creations, deletions, merges, restores, and association changes for different HubSpot objects.\",\"enum\":[\"company.associationChange\",\"company.creation\",\"company.deletion\",\"company.merge\",\"company.propertyChange\",\"company.restore\",\"contact.associationChange\",\"contact.creation\",\"contact.deletion\",\"contact.merge\",\"contact.privacyDeletion\",\"contact.propertyChange\",\"contact.restore\",\"conversation.creation\",\"conversation.deletion\",\"conversation.newMessage\",\"conversation.privacyDeletion\",\"conversation.propertyChange\",\"deal.associationChange\",\"deal.creation\",\"deal.deletion\",\"deal.merge\",\"deal.propertyChange\",\"deal.restore\",\"event.completed\",\"line_item.associationChange\",\"line_item.creation\",\"line_item.deletion\",\"line_item.merge\",\"line_item.propertyChange\",\"line_item.restore\",\"object.associationChange\",\"object.creation\",\"object.deletion\",\"object.merge\",\"object.propertyChange\",\"object.restore\",\"product.creation\",\"product.deletion\",\"product.merge\",\"product.propertyChange\",\"product.restore\",\"ticket.associationChange\",\"ticket.creation\",\"ticket.deletion\",\"ticket.merge\",\"ticket.propertyChange\",\"ticket.restore\"],\"example\":null,\"type\":\"string\"},\"eventTypeName\":{\"description\":\"The name of the event type for the subscription.\",\"example\":null,\"type\":\"string\"},\"id\":{\"description\":\"The unique identifier for the subscription. It is an integer formatted as int64.\",\"example\":null,\"type\":\"string\"},\"objectTypeId\":{\"description\":\"The identifier for the object type associated with the subscription. It is a string.\",\"example\":null,\"type\":\"string\"},\"propertyName\":{\"description\":\"The name of the property associated with the subscription event, if applicable.\",\"example\":null,\"type\":\"string\"},\"updatedAt\":{\"description\":\"The date and time when the subscription was last updated, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"}},\"required\":[\"active\",\"createdAt\",\"eventType\",\"id\"],\"type\":\"object\"}}},\"description\":\"successful operation\"},\"default\":{\"content\":{\"*/*\":{\"example\":null,\"schema\":{\"description\":\"Represents an error response returned by the API when an operation fails. This component is used in various endpoints to provide detailed information about the error encountered.\",\"example\":{\"category\":\"VALIDATION_ERROR\",\"correlationId\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"links\":{\"knowledge-base\":\"https://www.hubspot.com/products/service/knowledge-base\"},\"message\":\"Invalid input (details will vary based on the error)\"},\"properties\":{\"category\":{\"description\":\"The error category\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{invalidPropertyName=[propertyValue], missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"correlationId\":{\"description\":\"A unique identifier for the request. Include this value with any error reports or support tickets\",\"example\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"format\":\"uuid\",\"type\":\"string\"},\"errors\":{\"description\":\"further information about the error\",\"example\":null,\"items\":{\"description\":\"Represents detailed information about an error that occurred in the API. This component is used to provide additional context and specifics about errors, typically as part of an error response.\",\"example\":null,\"properties\":{\"code\":{\"description\":\"The status code associated with the error detail\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"in\":{\"description\":\"The name of the field or parameter in which the error was found.\",\"example\":null,\"type\":\"string\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":null,\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"message\"],\"type\":\"object\"},\"type\":\"array\"},\"links\":{\"additionalProperties\":{\"example\":null,\"type\":\"string\"},\"description\":\"A map of link names to associated URIs containing documentation about the error or recommended remediation steps\",\"example\":null,\"type\":\"object\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":\"An error occurred\",\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"category\",\"correlationId\",\"message\"],\"type\":\"object\"}}},\"description\":\"\"}},\"security\":[{\"oauth2\":[\"developers-read\"]},{\"oauth2\":[\"private-apps-read\"]}],\"securitySchemes\":{\"developer_hapikey\":{\"in\":\"query\",\"name\":\"hapikey\",\"type\":\"apiKey\"},\"oauth2\":{\"flows\":{\"authorizationCode\":{\"authorizationUrl\":\"https://app.hubspot.com/oauth/authorize\",\"scopes\":{\"developers-read\":\"\",\"developers-write\":\"\",\"private-apps-read\":\"\",\"private-apps-write\":\"\",\"webhooks-journal-data-access\":\"\",\"webhooks-journal-snapshot-management\":\"\",\"webhooks-journal-subscription-management\":\"\",\"webhooks-journal-subscription-read\":\"\"},\"tokenUrl\":\"https://api.hubapi.com/oauth/v1/token\"}},\"type\":\"oauth2\"},\"private_apps\":{\"in\":\"header\",\"name\":\"private-app\",\"type\":\"apiKey\"},\"private_apps_legacy\":{\"in\":\"header\",\"name\":\"private-app-legacy\",\"type\":\"apiKey\"}},\"securitySource\":\"operation\"}","source":"openapi3","version":1},"kind":"http","method":"GET","orig":"/app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}","rename":{"param":{"appId":"app_id","subscriptionId":"id"}},"segments":[{"lit":"app-webhooks"},{"lit":"2026-09"},{"var":"app_id"},{"lit":"subscriptions"},{"var":"id"}],"select":{"exist":["app_id","id"]},"transform":{"req":"`reqdata`","res":"`body`"},"index$":0}],"key$":"load"},"update":{"input":"data","name":"update","points":[{"active":true,"args":{"params":[{"active":true,"example":null,"kind":"param","name":"app_id","orig":"app_id","reqd":true,"type":"`$INTEGER`","index$":0},{"active":true,"example":null,"kind":"param","name":"id","orig":"subscription_id","reqd":true,"type":"`$INTEGER`","index$":1}]},"contract":{"id":"PATCH /app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}","json":"{\"operationId\":\"patch-/app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}_update\",\"parameters\":[{\"description\":\"The unique identifier of the app for which the subscription is being updated.\",\"explode\":false,\"in\":\"path\",\"name\":\"appId\",\"required\":true,\"schema\":{\"example\":null,\"format\":\"int32\",\"type\":\"integer\"},\"style\":\"simple\"},{\"description\":\"The unique identifier of the subscription to update.\",\"explode\":false,\"in\":\"path\",\"name\":\"subscriptionId\",\"required\":true,\"schema\":{\"example\":null,\"format\":\"int32\",\"type\":\"integer\"},\"style\":\"simple\"}],\"protocol\":\"http\",\"requestBody\":{\"content\":{\"application/json\":{\"example\":null,\"schema\":{\"example\":null,\"properties\":{\"active\":{\"description\":\"A boolean indicating whether the subscription is active. If true, the subscription is active; if false, it is inactive.\",\"example\":null,\"type\":\"boolean\"}},\"type\":\"object\"}}},\"required\":true},\"responses\":{\"200\":{\"content\":{\"application/json\":{\"example\":null,\"schema\":{\"example\":null,\"properties\":{\"active\":{\"description\":\"A boolean indicating whether the subscription is currently active.\",\"example\":null,\"type\":\"boolean\"},\"createdAt\":{\"description\":\"The date and time when the subscription was created, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"},\"eventType\":{\"description\":\"The type of event that triggers the subscription. Valid values include various property changes, creations, deletions, merges, restores, and association changes for different HubSpot objects.\",\"enum\":[\"company.associationChange\",\"company.creation\",\"company.deletion\",\"company.merge\",\"company.propertyChange\",\"company.restore\",\"contact.associationChange\",\"contact.creation\",\"contact.deletion\",\"contact.merge\",\"contact.privacyDeletion\",\"contact.propertyChange\",\"contact.restore\",\"conversation.creation\",\"conversation.deletion\",\"conversation.newMessage\",\"conversation.privacyDeletion\",\"conversation.propertyChange\",\"deal.associationChange\",\"deal.creation\",\"deal.deletion\",\"deal.merge\",\"deal.propertyChange\",\"deal.restore\",\"event.completed\",\"line_item.associationChange\",\"line_item.creation\",\"line_item.deletion\",\"line_item.merge\",\"line_item.propertyChange\",\"line_item.restore\",\"object.associationChange\",\"object.creation\",\"object.deletion\",\"object.merge\",\"object.propertyChange\",\"object.restore\",\"product.creation\",\"product.deletion\",\"product.merge\",\"product.propertyChange\",\"product.restore\",\"ticket.associationChange\",\"ticket.creation\",\"ticket.deletion\",\"ticket.merge\",\"ticket.propertyChange\",\"ticket.restore\"],\"example\":null,\"type\":\"string\"},\"eventTypeName\":{\"description\":\"The name of the event type for the subscription.\",\"example\":null,\"type\":\"string\"},\"id\":{\"description\":\"The unique identifier for the subscription. It is an integer formatted as int64.\",\"example\":null,\"type\":\"string\"},\"objectTypeId\":{\"description\":\"The identifier for the object type associated with the subscription. It is a string.\",\"example\":null,\"type\":\"string\"},\"propertyName\":{\"description\":\"The name of the property associated with the subscription event, if applicable.\",\"example\":null,\"type\":\"string\"},\"updatedAt\":{\"description\":\"The date and time when the subscription was last updated, in ISO 8601 format.\",\"example\":null,\"format\":\"date-time\",\"type\":\"string\"}},\"required\":[\"active\",\"createdAt\",\"eventType\",\"id\"],\"type\":\"object\"}}},\"description\":\"successful operation\"},\"default\":{\"content\":{\"*/*\":{\"example\":null,\"schema\":{\"description\":\"Represents an error response returned by the API when an operation fails. This component is used in various endpoints to provide detailed information about the error encountered.\",\"example\":{\"category\":\"VALIDATION_ERROR\",\"correlationId\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"links\":{\"knowledge-base\":\"https://www.hubspot.com/products/service/knowledge-base\"},\"message\":\"Invalid input (details will vary based on the error)\"},\"properties\":{\"category\":{\"description\":\"The error category\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{invalidPropertyName=[propertyValue], missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"correlationId\":{\"description\":\"A unique identifier for the request. Include this value with any error reports or support tickets\",\"example\":\"aeb5f871-7f07-4993-9211-075dc63e7cbf\",\"format\":\"uuid\",\"type\":\"string\"},\"errors\":{\"description\":\"further information about the error\",\"example\":null,\"items\":{\"description\":\"Represents detailed information about an error that occurred in the API. This component is used to provide additional context and specifics about errors, typically as part of an error response.\",\"example\":null,\"properties\":{\"code\":{\"description\":\"The status code associated with the error detail\",\"example\":null,\"type\":\"string\"},\"context\":{\"additionalProperties\":{\"example\":null,\"items\":{\"example\":null,\"type\":\"string\"},\"type\":\"array\"},\"description\":\"Context about the error condition\",\"example\":\"{missingScopes=[scope1, scope2]}\",\"type\":\"object\"},\"in\":{\"description\":\"The name of the field or parameter in which the error was found.\",\"example\":null,\"type\":\"string\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":null,\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"message\"],\"type\":\"object\"},\"type\":\"array\"},\"links\":{\"additionalProperties\":{\"example\":null,\"type\":\"string\"},\"description\":\"A map of link names to associated URIs containing documentation about the error or recommended remediation steps\",\"example\":null,\"type\":\"object\"},\"message\":{\"description\":\"A human readable message describing the error along with remediation steps where appropriate\",\"example\":\"An error occurred\",\"type\":\"string\"},\"subCategory\":{\"description\":\"A specific category that contains more specific detail about the error\",\"example\":null,\"type\":\"string\"}},\"required\":[\"category\",\"correlationId\",\"message\"],\"type\":\"object\"}}},\"description\":\"\"}},\"security\":[{\"oauth2\":[\"developers-write\"]},{\"oauth2\":[\"private-apps-write\"]}],\"securitySchemes\":{\"developer_hapikey\":{\"in\":\"query\",\"name\":\"hapikey\",\"type\":\"apiKey\"},\"oauth2\":{\"flows\":{\"authorizationCode\":{\"authorizationUrl\":\"https://app.hubspot.com/oauth/authorize\",\"scopes\":{\"developers-read\":\"\",\"developers-write\":\"\",\"private-apps-read\":\"\",\"private-apps-write\":\"\",\"webhooks-journal-data-access\":\"\",\"webhooks-journal-snapshot-management\":\"\",\"webhooks-journal-subscription-management\":\"\",\"webhooks-journal-subscription-read\":\"\"},\"tokenUrl\":\"https://api.hubapi.com/oauth/v1/token\"}},\"type\":\"oauth2\"},\"private_apps\":{\"in\":\"header\",\"name\":\"private-app\",\"type\":\"apiKey\"},\"private_apps_legacy\":{\"in\":\"header\",\"name\":\"private-app-legacy\",\"type\":\"apiKey\"}},\"securitySource\":\"operation\"}","source":"openapi3","version":1},"kind":"http","method":"PATCH","orig":"/app-webhooks/2026-09/{appId}/subscriptions/{subscriptionId}","rename":{"param":{"appId":"app_id","subscriptionId":"id"}},"segments":[{"lit":"app-webhooks"},{"lit":"2026-09"},{"var":"app_id"},{"lit":"subscriptions"},{"var":"id"}],"select":{"exist":["app_id","id"]},"transform":{"req":"`reqdata`","res":"`body`"},"index$":0}],"key$":"update"}},"relations":{"ancestors":[["2026_09"]]},"key$":"webhooks_subscription","name__orig":"webhooks_subscription","Name":"WebhooksSubscription","name_":"webhooks_subscription","name-":"webhooks-subscription","NAME":"WEBHOOKS_SUBSCRIPTION","index$":8}, {"active":true,"entity":"webhooks_subscription","key$":"BasicWebhooksSubscriptionFlow","kind":"basic","name":"BasicWebhooksSubscriptionFlow","param":{},"step":[{"active":true,"data":{},"input":{"ref":"webhooks_subscription_ref01"},"match":{"app_id":"app01"},"op":"create","spec":[],"valid":[],"index$":0},{"active":true,"data":{"app_id":"app01"},"input":{"ref":"webhooks_subscription_ref01","srcdatavar":"webhooks_subscription_ref01_data","suffix":"_up0","textfield":"createdAt"},"match":{},"op":"update","spec":[{"apply":"TextFieldMark","def":{"mark":"Mark01-webhooks_subscription_ref01"}}],"valid":[],"index$":1},{"active":true,"data":{},"input":{"ref":"webhooks_subscription_ref01","srcdatavar":"webhooks_subscription_ref01_data","suffix":"_dt0"},"match":{"app_id":"app01","id":"webhooks_subscription01"},"op":"load","spec":[],"valid":[{"apply":"TextFieldMark","def":{"mark":"Mark01-webhooks_subscription_ref01"}}],"index$":2}]}, 'WebhooksSubscription')
    }
