...
describe('WebhooksSubscriptionListEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let webhooks_subscription_list_ref01_data = Object.values(setup.data.existing.webhooks_subscription_list)[0] as any

    // LIST
    const webhooks_subscription_list_ref01_ent = client.WebhooksSubscriptionList()
    const webhooks_subscription_list_ref01_match: any = {}
    webhooks_subscription_list_ref01_match['2026_09_id'] = setup.idmap['2026_0901']

    const webhooks_subscription_list_ref01_list = (await webhooks_subscription_list_ref01_ent.list(webhooks_subscription_list_ref01_match)).map((e: any) => e.data())
