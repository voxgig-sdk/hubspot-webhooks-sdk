...
describe('WebhooksCollectionResponseSubscriptionResponseNoPagingEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'webhooks_collection_response_subscription_response_no_paging.' + op, live)) return
    }
    ...
    let webhooks_collection_response_subscription_response_no_paging_ref01_data = Object.values(setup.data.existing.webhooks_collection_response_subscription_response_no_paging)[0] as any
    ...
    const webhooks_collection_response_subscription_response_no_paging_ref01_match: any = {}

    const webhooks_collection_response_subscription_response_no_paging_ref01_list = (await webhooks_collection_response_subscription_response_no_paging_ref01_ent.list(webhooks_collection_response_subscription_response_no_paging_ref01_match)).map((e: any) => e.data())
