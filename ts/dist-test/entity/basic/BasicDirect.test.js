...
(0, node_test_1.describe)('BasicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-basic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-basic', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["offset_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_WEBHOOKS_TEST_BASIC_ENTID'];
...
//# sourceMappingURL=BasicDirect.test.js.map