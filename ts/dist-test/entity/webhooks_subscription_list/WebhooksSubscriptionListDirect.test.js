...
(0, node_test_1.describe)('WebhooksSubscriptionListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-webhooks_subscription_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-webhooks_subscription_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["app01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_LIST_ENTID'];
...
//# sourceMappingURL=WebhooksSubscriptionListDirect.test.js.map