...
(0, node_test_1.describe)('WebhooksCollectionResponseSubscriptionResponseNoPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-webhooks_collection_response_subscription_response_no_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-webhooks_collection_response_subscription_response_no_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_COLLECTION_RESPONSE_SUBSCRIPTION_RESPONSE_NO_PAGING_ENTID'];
...
//# sourceMappingURL=WebhooksCollectionResponseSubscriptionResponseNoPagingDirect.test.js.map