...
(0, node_test_1.describe)('WebhooksCollectionResponseSubscriptionResponseNoPagingEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/webhooks_collection_response_subscription_response_no_paging/WebhooksCollectionResponseSubscriptionResponseNoPagingTestData.json');
    ...
    let idmap = transform(['webhooks_collection_response_subscription_response_no_paging01', 'webhooks_collection_response_subscription_response_no_paging02', 'webhooks_collection_response_subscription_response_no_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=WebhooksCollectionResponseSubscriptionResponseNoPagingEntity.test.js.map