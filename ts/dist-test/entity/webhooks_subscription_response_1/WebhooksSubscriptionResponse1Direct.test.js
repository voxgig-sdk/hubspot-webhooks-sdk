...
(0, node_test_1.describe)('WebhooksSubscriptionResponse1Direct', async () => {
    ...
    (0, node_test_1.test)('direct-load-webhooks_subscription_response_1', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webhooks_subscription_response_1', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["subscription_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_RESPONSE_1_ENTID'];
...
//# sourceMappingURL=WebhooksSubscriptionResponse1Direct.test.js.map