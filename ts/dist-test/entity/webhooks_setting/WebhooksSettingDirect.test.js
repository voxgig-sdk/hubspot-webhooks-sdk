...
(0, node_test_1.describe)('WebhooksSettingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-webhooks_setting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webhooks_setting', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["2026_09_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SETTING_ENTID'];
...
//# sourceMappingURL=WebhooksSettingDirect.test.js.map