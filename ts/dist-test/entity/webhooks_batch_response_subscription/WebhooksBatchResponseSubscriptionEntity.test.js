...
function basicSetup(extra) {
    ...
    let idmap = transform(['webhooks_batch_response_subscription01', 'webhooks_batch_response_subscription02', 'webhooks_batch_response_subscription03', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
