...
function envOverride(m) {
    if ('TRUE' === process.env.HUBSPOT_WEBHOOKS_TEST_LIVE ||
        'TRUE' === process.env.HUBSPOT_WEBHOOKS_TEST_OVERRIDE) {
    ...
    m.HUBSPOT_WEBHOOKS_TEST_EXPLAIN = process.env.HUBSPOT_WEBHOOKS_TEST_EXPLAIN || m.HUBSPOT_WEBHOOKS_TEST_EXPLAIN;
    return m;
}
