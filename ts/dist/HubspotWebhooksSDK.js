...
exports.SDK = exports.HubspotWebhooksSDK = exports.HubspotWebhooksEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
...
const HubspotWebhooksEntityBase_1 = require("./HubspotWebhooksEntityBase");
Object.defineProperty(exports, "HubspotWebhooksEntityBase", { enumerable: true, get: function () { return HubspotWebhooksEntityBase_1.HubspotWebhooksEntityBase; } });
...
class HubspotWebhooksSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('HubspotWebhooksSDK: graphql: ' +
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksBatchResponseJournalFetch(entopts) {
        const self = this;
        return new WebhooksBatchResponseJournalFetchEntity_1.WebhooksBatchResponseJournalFetchEntity(self, entopts);
    }
    // Entity access: `client.WebhooksBatchResponseSubscription().list()` / `client.WebhooksBatchResponseSubscription().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksBatchResponseSubscription(entopts) {
        const self = this;
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksCrmObjectSnapshotBatch(entopts) {
        const self = this;
        return new WebhooksCrmObjectSnapshotBatchEntity_1.WebhooksCrmObjectSnapshotBatchEntity(self, entopts);
    }
    // Entity access: `client.WebhooksFilter().list()` / `client.WebhooksFilter().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksFilter(entopts) {
        const self = this;
        return new WebhooksFilterEntity_1.WebhooksFilterEntity(self, entopts);
    }
    // Entity access: `client.WebhooksSetting().list()` / `client.WebhooksSetting().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksSetting(entopts) {
        const self = this;
        return new WebhooksSettingEntity_1.WebhooksSettingEntity(self, entopts);
    }
    // Entity access: `client.WebhooksSnapshotStatus().list()` / `client.WebhooksSnapshotStatus().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksSnapshotStatus(entopts) {
        const self = this;
        return new WebhooksSnapshotStatusEntity_1.WebhooksSnapshotStatusEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    WebhooksSubscriptionResponse1(entopts) {
        const self = this;
        return new WebhooksSubscriptionResponse1Entity_1.WebhooksSubscriptionResponse1Entity(self, entopts);
    }
...
exports.HubspotWebhooksSDK = HubspotWebhooksSDK;
const SDK = HubspotWebhooksSDK;
exports.SDK = SDK;
//# sourceMappingURL=HubspotWebhooksSDK.js.map