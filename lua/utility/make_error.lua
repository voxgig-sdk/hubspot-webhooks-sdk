...
local function make_error_util(ctx, err)
  ...
  local msg = "HubspotWebhooksSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HubspotWebhooksError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HubspotWebhooksError then
