...
describe("WebhooksSnapshotStatusDirect", function()
  it("should direct-load-webhooks_snapshot_status", function()
    local setup = webhooks_snapshot_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-webhooks_snapshot_status", setup.live and "live" or "unit")
