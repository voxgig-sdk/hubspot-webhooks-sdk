...
describe("WebhooksSettingDirect", function()
  it("should direct-load-webhooks_setting", function()
    local setup = webhooks_setting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-webhooks_setting", setup.live and "live" or "unit")
