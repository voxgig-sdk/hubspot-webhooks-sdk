...
describe("WebhooksSubscriptionListDirect", function()
  it("should direct-list-webhooks_subscription_list", function()
    local setup = webhooks_subscription_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-webhooks_subscription_list", setup.live and "live" or "unit")
