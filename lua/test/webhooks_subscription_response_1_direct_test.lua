...
describe("WebhooksSubscriptionResponse1Direct", function()
  it("should direct-load-webhooks_subscription_response_1", function()
    local setup = webhooks_subscription_response_1_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-webhooks_subscription_response_1", setup.live and "live" or "unit")
