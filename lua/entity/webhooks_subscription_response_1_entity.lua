...
local WebhooksSubscriptionResponse1Entity = {}
WebhooksSubscriptionResponse1Entity.__index = WebhooksSubscriptionResponse1Entity


function WebhooksSubscriptionResponse1Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksSubscriptionResponse1Entity)
  self._name = "webhooks_subscription_response_1"
  self._client = client
...
function WebhooksSubscriptionResponse1Entity:get_name()
  return self._name
end


function WebhooksSubscriptionResponse1Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksSubscriptionResponse1Entity.new(self._client, opts)
end
...
function WebhooksSubscriptionResponse1Entity:mark_deleted()
  self._deleted = true
end


function WebhooksSubscriptionResponse1Entity:deleted()
  return true == self._deleted
end


function WebhooksSubscriptionResponse1Entity:data_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionResponse1Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksSubscriptionResponse1Entity:match_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionResponse1Entity:match_get()
...
function WebhooksSubscriptionResponse1Entity:stream(action, args, callopts)
...
---@param reqmatch WebhooksSubscriptionResponse1LoadMatch
---@param ctrl? table
---@return WebhooksSubscriptionResponse1
---@return string? err
function WebhooksSubscriptionResponse1Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata WebhooksSubscriptionResponse1CreateData
---@param ctrl? table
---@return WebhooksSubscriptionResponse1
---@return string? err
function WebhooksSubscriptionResponse1Entity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function WebhooksSubscriptionResponse1Entity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WebhooksSubscriptionResponse1Entity
