-- HubspotWebhooks SDK WebhooksBatchResponseSubscription entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WebhooksBatchResponseSubscriptionEntity = {}
WebhooksBatchResponseSubscriptionEntity.__index = WebhooksBatchResponseSubscriptionEntity


function WebhooksBatchResponseSubscriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksBatchResponseSubscriptionEntity)
  self._name = "webhooks_batch_response_subscription"
  self._client = client
...
function WebhooksBatchResponseSubscriptionEntity:get_name()
  return self._name
end


function WebhooksBatchResponseSubscriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksBatchResponseSubscriptionEntity.new(self._client, opts)
end
...
function WebhooksBatchResponseSubscriptionEntity:mark_deleted()
  self._deleted = true
end


function WebhooksBatchResponseSubscriptionEntity:deleted()
  return true == self._deleted
end


function WebhooksBatchResponseSubscriptionEntity:data_set(args)
  if args ~= nil then
...
function WebhooksBatchResponseSubscriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksBatchResponseSubscriptionEntity:match_set(args)
  if args ~= nil then
...
function WebhooksBatchResponseSubscriptionEntity:match_get()
...
function WebhooksBatchResponseSubscriptionEntity:stream(action, args, callopts)
...
---@param reqdata WebhooksBatchResponseSubscriptionCreateData
---@param ctrl? table
---@return WebhooksBatchResponseSubscription
---@return string? err
function WebhooksBatchResponseSubscriptionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function WebhooksBatchResponseSubscriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WebhooksBatchResponseSubscriptionEntity
