-- HubspotWebhooks SDK WebhooksSubscriptionList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WebhooksSubscriptionListEntity = {}
WebhooksSubscriptionListEntity.__index = WebhooksSubscriptionListEntity


function WebhooksSubscriptionListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksSubscriptionListEntity)
  self._name = "webhooks_subscription_list"
  self._client = client
...
function WebhooksSubscriptionListEntity:get_name()
  return self._name
end


function WebhooksSubscriptionListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksSubscriptionListEntity.new(self._client, opts)
end
...
function WebhooksSubscriptionListEntity:mark_deleted()
  self._deleted = true
end


function WebhooksSubscriptionListEntity:deleted()
  return true == self._deleted
end


function WebhooksSubscriptionListEntity:data_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksSubscriptionListEntity:match_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionListEntity:match_get()
...
function WebhooksSubscriptionListEntity:stream(action, args, callopts)
...
---@param reqmatch WebhooksSubscriptionListListMatch
---@param ctrl? table
---@return WebhooksSubscriptionList[]
---@return string? err
function WebhooksSubscriptionListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function WebhooksSubscriptionListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WebhooksSubscriptionListEntity
