...
local WebhooksSubscriptionEntity = {}
WebhooksSubscriptionEntity.__index = WebhooksSubscriptionEntity


function WebhooksSubscriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksSubscriptionEntity)
  self._name = "webhooks_subscription"
  self._client = client
...
function WebhooksSubscriptionEntity:get_name()
  return self._name
end


function WebhooksSubscriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksSubscriptionEntity.new(self._client, opts)
end
...
function WebhooksSubscriptionEntity:mark_deleted()
  self._deleted = true
end


function WebhooksSubscriptionEntity:deleted()
  return true == self._deleted
end


function WebhooksSubscriptionEntity:data_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksSubscriptionEntity:match_set(args)
  if args ~= nil then
...
function WebhooksSubscriptionEntity:match_get()
...
function WebhooksSubscriptionEntity:stream(action, args, callopts)
...
---@param reqmatch WebhooksSubscriptionLoadMatch
---@param ctrl? table
---@return WebhooksSubscription
---@return string? err
function WebhooksSubscriptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata WebhooksSubscriptionCreateData
---@param ctrl? table
---@return WebhooksSubscription
---@return string? err
function WebhooksSubscriptionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata WebhooksSubscriptionUpdateData
---@param ctrl? table
---@return WebhooksSubscription
---@return string? err
function WebhooksSubscriptionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function WebhooksSubscriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WebhooksSubscriptionEntity
