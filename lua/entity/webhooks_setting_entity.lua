...
local WebhooksSettingEntity = {}
WebhooksSettingEntity.__index = WebhooksSettingEntity


function WebhooksSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksSettingEntity)
  self._name = "webhooks_setting"
  self._client = client
...
function WebhooksSettingEntity:get_name()
  return self._name
end


function WebhooksSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksSettingEntity.new(self._client, opts)
end
...
function WebhooksSettingEntity:mark_deleted()
  self._deleted = true
end


function WebhooksSettingEntity:deleted()
  return true == self._deleted
end


function WebhooksSettingEntity:data_set(args)
  if args ~= nil then
...
function WebhooksSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksSettingEntity:match_set(args)
  if args ~= nil then
...
function WebhooksSettingEntity:match_get()
...
function WebhooksSettingEntity:stream(action, args, callopts)
...
---@param reqmatch WebhooksSettingLoadMatch
---@param ctrl? table
---@return WebhooksSetting
---@return string? err
function WebhooksSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata WebhooksSettingUpdateData
---@param ctrl? table
---@return WebhooksSetting
---@return string? err
function WebhooksSettingEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function WebhooksSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
