-- HubspotWebhooks SDK WebhooksCollectionResponseSubscriptionResponseNoPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WebhooksCollectionResponseSubscriptionResponseNoPagingEntity = {}
WebhooksCollectionResponseSubscriptionResponseNoPagingEntity.__index = WebhooksCollectionResponseSubscriptionResponseNoPagingEntity


function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WebhooksCollectionResponseSubscriptionResponseNoPagingEntity)
  self._name = "webhooks_collection_response_subscription_response_no_paging"
  self._client = client
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:get_name()
  return self._name
end


function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WebhooksCollectionResponseSubscriptionResponseNoPagingEntity.new(self._client, opts)
end
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:mark_deleted()
  self._deleted = true
end


function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:deleted()
  return true == self._deleted
end


function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:data_set(args)
  if args ~= nil then
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:match_set(args)
  if args ~= nil then
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:match_get()
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:stream(action, args, callopts)
...
---@param reqmatch WebhooksCollectionResponseSubscriptionResponseNoPagingListMatch
---@param ctrl? table
---@return WebhooksCollectionResponseSubscriptionResponseNoPaging[]
---@return string? err
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WebhooksCollectionResponseSubscriptionResponseNoPagingEntity
