...
|---|---|---|
| `js/` | @voxgig-sdk/hubspot-webhooks-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/hubspot-webhooks | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hubspot-webhooks-js \
      --repository voxgig-sdk/hubspot-webhooks-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hubspot-webhooks-js` shows it, and
`npm trust revoke @voxgig-sdk/hubspot-webhooks-js --id=<id>` removes it.
