...
// HubspotWebhooks SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HubspotWebhooksOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HubspotWebhooksOmni::structfix($now, Struct::undef()))
                        !== json_encode(HubspotWebhooksOmni::structfix($val, Struct::undef()))) {
