...
// HubspotWebhooks SDK pipeline test
//
...
{
    private static function utility(): HubspotWebhooksUtility
    {
        return new HubspotWebhooksUtility();
    }
    ...
    private static function ctx(array $over = []): HubspotWebhooksContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HubspotWebhooksContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HubspotWebhooksOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HubspotWebhooksError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HubspotWebhooksOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HubspotWebhooksMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HubspotWebhooksOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HubspotWebhooksMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HubspotWebhooksOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HubspotWebhooksMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotWebhooksSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HubspotWebhooksMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HubspotWebhooksResponse([]),
            'result' => new HubspotWebhooksResult([]),
        ]);
        [, $err] = HubspotWebhooksMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec([]),
            'response' => null,
            'result' => new HubspotWebhooksResult([]),
        ]);
        [, $err] = HubspotWebhooksMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec(['step' => 's']),
            'response' => new HubspotWebhooksResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HubspotWebhooksResult([]),
        ]);
        [, $err] = HubspotWebhooksMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec(['step' => 's']),
            'response' => new HubspotWebhooksResponse(self::resp(200, ['v' => 1])),
            'result' => new HubspotWebhooksResult([]),
        ]);
        [, $err] = HubspotWebhooksMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec(['step' => 's']),
            'response' => new HubspotWebhooksResponse(self::resp(200, ['v' => 2])),
            'result' => new HubspotWebhooksResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HubspotWebhooksMakeResponse::call($ctx);
    ...
    {
        $preset = new HubspotWebhooksResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec([]),
            'response' => new HubspotWebhooksResponse([]),
            'result' => new HubspotWebhooksResult([]),
        ...
        [$got, $err] = HubspotWebhooksMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HubspotWebhooksResult([])]);
        [, $err] = HubspotWebhooksMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HubspotWebhooksSpec([]), 'result' => null]);
        [, $err] = HubspotWebhooksMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotWebhooksSpec(['step' => 's']),
            'result' => new HubspotWebhooksResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HubspotWebhooksOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotWebhooksMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotWebhooksSpec(['step' => 's']),
            'result' => new HubspotWebhooksResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HubspotWebhooksOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotWebhooksMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotWebhooksResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HubspotWebhooksSpec([]),
            'result' => new HubspotWebhooksResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HubspotWebhooksMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotWebhooksMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HubspotWebhooksError('boom', 'boom');
        $utility->fetcher = function (HubspotWebhooksContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotWebhooksSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HubspotWebhooksMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HubspotWebhooksContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HubspotWebhooksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HubspotWebhooksResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HubspotWebhooksMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HubspotWebhooksContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotWebhooksSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HubspotWebhooksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HubspotWebhooksResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HubspotWebhooksSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HubspotWebhooksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HubspotWebhooksMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HubspotWebhooksMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HubspotWebhooksResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HubspotWebhooksDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HubspotWebhooksResult(['ok' => false])]);
        $this->expectException(HubspotWebhooksError::class);
        HubspotWebhooksDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HubspotWebhooksResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HubspotWebhooksMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HubspotWebhooksMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HubspotWebhooksBaseFeature();
        $b = new HubspotWebhooksBaseFeature();
        HubspotWebhooksFeatureAdd::call($ctx, $a);
        HubspotWebhooksFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HubspotWebhooksBaseFeature
    {
        $f = new HubspotWebhooksBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HubspotWebhooksFeatureAdd::call($ctx, self::named_feature('a'));
        HubspotWebhooksFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HubspotWebhooksFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HubspotWebhooksFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HubspotWebhooksFeatureAdd::call($ctx, $replace);
        ...
        HubspotWebhooksFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HubspotWebhooksContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HubspotWebhooksSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotWebhooksPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HubspotWebhooksPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HubspotWebhooksResponse(['headers' => null]),
            'result' => new HubspotWebhooksResult([]),
        ]);
        HubspotWebhooksResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HubspotWebhooksResultBody::call($ctx);
