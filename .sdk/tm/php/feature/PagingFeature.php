...
// HubspotWebhooks SDK paging feature
...
class HubspotWebhooksPagingFeature extends HubspotWebhooksBaseFeature
{
    ...
    private function _graphql_pre_request(HubspotWebhooksContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(HubspotWebhooksContext $ctx): bool
    {
