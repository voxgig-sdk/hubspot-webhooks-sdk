...
from hubspotwebhooks_sdk.core.control import HubspotWebhooksControl
...
from hubspotwebhooks_sdk.core.helpers import get_ctx_prop, to_map
...
class HubspotWebhooksContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HubspotWebhooksControl()
        ...
        if isinstance(sp, HubspotWebhooksSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HubspotWebhooksResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HubspotWebhooksResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HubspotWebhooksOperation({})
    ...
    def make_error(self, code, msg):
        return HubspotWebhooksError(code, msg, self)
