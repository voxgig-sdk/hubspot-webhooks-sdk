...
class WebhooksSubscriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksSubscriptionEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksSubscription:
    ...
    def match_get(self) -> WebhooksSubscription:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhooksSubscription:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhooksSubscription().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: WebhooksSubscriptionCreateData, ctrl=None) -> WebhooksSubscription:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: WebhooksSubscriptionUpdateData, ctrl=None) -> WebhooksSubscription:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
