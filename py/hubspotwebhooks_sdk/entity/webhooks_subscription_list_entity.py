...
class WebhooksSubscriptionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksSubscriptionListEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksSubscriptionList:
    ...
    def match_get(self) -> WebhooksSubscriptionList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WebhooksSubscriptionList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WebhooksSubscriptionList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
