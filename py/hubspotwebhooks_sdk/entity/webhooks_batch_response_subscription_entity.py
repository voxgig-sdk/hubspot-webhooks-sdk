...
class WebhooksBatchResponseSubscriptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksBatchResponseSubscriptionEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksBatchResponseSubscription:
    ...
    def match_get(self) -> WebhooksBatchResponseSubscription:
    ...
    def create(self, reqdata: WebhooksBatchResponseSubscriptionCreateData, ctrl=None) -> WebhooksBatchResponseSubscription:
        utility = self._utility
