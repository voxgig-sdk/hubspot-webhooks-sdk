...
class WebhooksSnapshotStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksSnapshotStatusEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksSnapshotStatus:
    ...
    def match_get(self) -> WebhooksSnapshotStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhooksSnapshotStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhooksSnapshotStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
