...
class WebhooksCrmObjectSnapshotBatchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksCrmObjectSnapshotBatchEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksCrmObjectSnapshotBatch:
    ...
    def match_get(self) -> WebhooksCrmObjectSnapshotBatch:
    ...
    def create(self, reqdata: WebhooksCrmObjectSnapshotBatchCreateData, ctrl=None) -> WebhooksCrmObjectSnapshotBatch:
        utility = self._utility
