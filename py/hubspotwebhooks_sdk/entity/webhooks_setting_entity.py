...
class WebhooksSettingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksSettingEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksSetting:
    ...
    def match_get(self) -> WebhooksSetting:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhooksSetting:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhooksSetting().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: WebhooksSettingUpdateData, ctrl=None) -> WebhooksSetting:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
