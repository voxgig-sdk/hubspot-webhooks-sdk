...
class WebhooksSubscriptionResponse1Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksSubscriptionResponse1Entity(self._client, opts)
    ...
    def data_get(self) -> WebhooksSubscriptionResponse1:
    ...
    def match_get(self) -> WebhooksSubscriptionResponse1:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhooksSubscriptionResponse1:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhooksSubscriptionResponse1().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
