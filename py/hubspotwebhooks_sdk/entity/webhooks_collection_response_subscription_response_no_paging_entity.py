...
class WebhooksCollectionResponseSubscriptionResponseNoPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksCollectionResponseSubscriptionResponseNoPagingEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksCollectionResponseSubscriptionResponseNoPaging:
    ...
    def match_get(self) -> WebhooksCollectionResponseSubscriptionResponseNoPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WebhooksCollectionResponseSubscriptionResponseNoPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WebhooksCollectionResponseSubscriptionResponseNoPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
