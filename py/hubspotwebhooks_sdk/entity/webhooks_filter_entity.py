...
class WebhooksFilterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebhooksFilterEntity(self._client, opts)
    ...
    def data_get(self) -> WebhooksFilter:
    ...
    def match_get(self) -> WebhooksFilter:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebhooksFilter:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebhooksFilter().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: WebhooksFilterCreateData, ctrl=None) -> WebhooksFilter:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
