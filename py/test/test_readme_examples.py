# HubspotWebhooks SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HubspotWebhooksSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HubspotWebhooksSDK(...) and HubspotWebhooksSDK.test(...) become
#      HubspotWebhooksSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hubspotwebhooks_sdk"
_SDK_CLASS = "HubspotWebhooksSDK"
