...
class TestWebhooksSubscriptionEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_ENTID JSON to run live")
        client = setup["client"]
        ...
        webhooks_subscription_ref01_markdef_up0_value = "Mark01-webhooks_subscription_ref01_" + str(setup["now"])
        ...
        webhooks_subscription_ref01_resdata_up0 = helpers.to_map(runner.entity_data(webhooks_subscription_ref01_ent.update(webhooks_subscription_ref01_data_up0_up, None)))
        assert webhooks_subscription_ref01_resdata_up0 is not None
        assert webhooks_subscription_ref01_resdata_up0["id"] == webhooks_subscription_ref01_data_up0_up["id"]
        assert webhooks_subscription_ref01_resdata_up0[webhooks_subscription_ref01_markdef_up0_name] == webhooks_subscription_ref01_markdef_up0_value

        # LOAD
        webhooks_subscription_ref01_match_dt0 = {
            "id": webhooks_subscription_ref01_data["id"],
        }
        webhooks_subscription_ref01_data_dt0_loaded = webhooks_subscription_ref01_ent.load(webhooks_subscription_ref01_match_dt0, None)
        webhooks_subscription_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(webhooks_subscription_ref01_data_dt0_loaded))
        assert webhooks_subscription_ref01_data_dt0_load_result is not None
        assert webhooks_subscription_ref01_data_dt0_load_result["id"] == webhooks_subscription_ref01_data["id"]



def _webhooks_subscription_basic_setup(extra):
    runner.load_env_local()

    entity_data_file = os.path.join(_TEST_DIR, "../../.sdk/test/entity/webhooks_subscription/WebhooksSubscriptionTestData.json")
    ...
    _entid_env_raw = os.environ.get(
        "HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_ENTID")
