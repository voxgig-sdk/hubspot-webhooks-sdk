// Command HubspotWebhooks-cli is a CLI + REPL for the HubspotWebhooks SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      HUBSPOT_WEBHOOKS_APIKEY (api key), HUBSPOT_WEBHOOKS_BASE (base url override)")
