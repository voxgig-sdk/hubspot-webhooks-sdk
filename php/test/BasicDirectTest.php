...
class BasicDirectTest extends TestCase
{
    public function test_direct_load_basic(): void
    {
        $setup = basic_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-basic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function basic_direct_setup($mockres)
{
