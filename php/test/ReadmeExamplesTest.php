...
// HubspotWebhooks SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HubspotWebhooksSDK::test)
...
{
    private const SDK_CLASS = 'HubspotWebhooksSDK';
    ...
    private const SDK_BASE = 'hubspotwebhooks_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hubspotwebhooks_sdk.php';
