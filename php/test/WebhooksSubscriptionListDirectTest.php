...
class WebhooksSubscriptionListDirectTest extends TestCase
{
    public function test_direct_list_webhooks_subscription_list(): void
    {
        $setup = webhooks_subscription_list_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-webhooks_subscription_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function webhooks_subscription_list_direct_setup($mockres)
{
