...
class WebhooksSettingDirectTest extends TestCase
{
    public function test_direct_load_webhooks_setting(): void
    {
        $setup = webhooks_setting_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-webhooks_setting", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function webhooks_setting_direct_setup($mockres)
{
