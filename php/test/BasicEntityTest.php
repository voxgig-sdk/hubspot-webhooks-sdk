...
class BasicEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HUBSPOT_WEBHOOKS_TEST_BASIC_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        // LOAD
        $basic_ref01_ent = $client->Basic(null);
        $basic_ref01_match_dt0 = [];
        $basic_ref01_data_dt0_loaded = $basic_ref01_ent->load($basic_ref01_match_dt0, null);
        $this->assertNotNull($basic_ref01_data_dt0_loaded);
...
function basic_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HUBSPOT_WEBHOOKS_TEST_BASIC_ENTID");
