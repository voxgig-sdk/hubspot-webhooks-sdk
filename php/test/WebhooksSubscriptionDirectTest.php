...
// WebhooksSubscription direct test
...
class WebhooksSubscriptionDirectTest extends TestCase
{
    public function test_direct_load_webhooks_subscription(): void
    {
        $setup = webhooks_subscription_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-webhooks_subscription", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function webhooks_subscription_direct_setup($mockres)
{
