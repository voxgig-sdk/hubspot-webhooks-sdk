...
class WebhooksSubscriptionEntityTest extends TestCase
{
    public function test_create_instance(): void
    {
        $testsdk = HubspotWebhooksSDK::test(null, null);
        $ent = $testsdk->WebhooksSubscription(null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $webhooks_subscription_ref01_markdef_up0_value = "Mark01-webhooks_subscription_ref01_" . $setup["now"];
        ...
        $webhooks_subscription_ref01_resdata_up0_result = $webhooks_subscription_ref01_ent->update($webhooks_subscription_ref01_data_up0_up, null);
        $webhooks_subscription_ref01_resdata_up0 = Helpers::to_map(is_object($webhooks_subscription_ref01_resdata_up0_result) && method_exists($webhooks_subscription_ref01_resdata_up0_result, 'data_get') ? $webhooks_subscription_ref01_resdata_up0_result->data_get() : $webhooks_subscription_ref01_resdata_up0_result);
        $this->assertNotNull($webhooks_subscription_ref01_resdata_up0);
        $this->assertEquals($webhooks_subscription_ref01_resdata_up0["id"], $webhooks_subscription_ref01_data_up0_up["id"]);
        $this->assertEquals($webhooks_subscription_ref01_resdata_up0[$webhooks_subscription_ref01_markdef_up0_name], $webhooks_subscription_ref01_markdef_up0_value);

        // LOAD
        $webhooks_subscription_ref01_match_dt0 = [
            "id" => $webhooks_subscription_ref01_data["id"],
        ];
        $webhooks_subscription_ref01_data_dt0_loaded = $webhooks_subscription_ref01_ent->load($webhooks_subscription_ref01_match_dt0, null);
        $webhooks_subscription_ref01_data_dt0_load_result = Helpers::to_map(is_object($webhooks_subscription_ref01_data_dt0_loaded) && method_exists($webhooks_subscription_ref01_data_dt0_loaded, 'data_get') ? $webhooks_subscription_ref01_data_dt0_loaded->data_get() : $webhooks_subscription_ref01_data_dt0_loaded);
        $this->assertNotNull($webhooks_subscription_ref01_data_dt0_load_result);
        $this->assertEquals($webhooks_subscription_ref01_data_dt0_load_result["id"], $webhooks_subscription_ref01_data["id"]);
...
function webhooks_subscription_basic_setup($extra)
{
    ...
    $entity_data_file = __DIR__ . '/../../.sdk/test/entity/webhooks_subscription/WebhooksSubscriptionTestData.json';
    ...
    $entid_env_raw = getenv("HUBSPOT_WEBHOOKS_TEST_WEBHOOKS_SUBSCRIPTION_ENTID");
