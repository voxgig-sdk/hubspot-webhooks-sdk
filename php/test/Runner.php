...
class HubspotWebhooksTestRunner
{
    ...
    {
        $live = self::getenv('HUBSPOT_WEBHOOKS_TEST_LIVE');
        $override = self::getenv('HUBSPOT_WEBHOOKS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HUBSPOT_WEBHOOKS_TEST_EXPLAIN');
...
class_alias('HubspotWebhooksTestRunner', 'Runner');
class_alias('HubspotWebhooksHelpers', 'Helpers');
