...
// HubspotWebhooks SDK WebhooksSnapshotStatus entity
...
class WebhooksSnapshotStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_snapshot_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksSnapshotStatusEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksSnapshotStatus|array $args WebhooksSnapshotStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksSnapshotStatus|array The current WebhooksSnapshotStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksSnapshotStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksSnapshotStatus fields).
     */
    ...
    /**
     * Load a single WebhooksSnapshotStatus.
     *
     * @param WebhooksSnapshotStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksSnapshotStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSnapshotStatus|array The loaded WebhooksSnapshotStatus as an assoc-array at the
