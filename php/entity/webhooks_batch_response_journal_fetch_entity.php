...
// HubspotWebhooks SDK WebhooksBatchResponseJournalFetch entity
...
class WebhooksBatchResponseJournalFetchEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_batch_response_journal_fetch";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksBatchResponseJournalFetchEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksBatchResponseJournalFetch|array $args WebhooksBatchResponseJournalFetch data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksBatchResponseJournalFetch|array The current WebhooksBatchResponseJournalFetch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksBatchResponseJournalFetch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksBatchResponseJournalFetch fields).
     */
    ...
    /**
     * Load a single WebhooksBatchResponseJournalFetch.
     *
     * @param WebhooksBatchResponseJournalFetchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksBatchResponseJournalFetchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksBatchResponseJournalFetch|array The loaded WebhooksBatchResponseJournalFetch as an assoc-array at the
    ...
    /**
     * Create a new WebhooksBatchResponseJournalFetch.
     *
     * @param WebhooksBatchResponseJournalFetchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksBatchResponseJournalFetchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksBatchResponseJournalFetch|array The created WebhooksBatchResponseJournalFetch as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
