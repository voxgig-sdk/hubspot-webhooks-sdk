...
// HubspotWebhooks SDK Basic entity
...
class BasicEntity
{
     ...
     * Load a single Basic.
     *
     * @param BasicLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BasicLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Basic|array The loaded Basic as an assoc-array at the
