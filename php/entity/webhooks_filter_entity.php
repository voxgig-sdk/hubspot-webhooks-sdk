...
// HubspotWebhooks SDK WebhooksFilter entity
...
class WebhooksFilterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksFilterEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksFilter|array $args WebhooksFilter data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksFilter|array The current WebhooksFilter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksFilter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksFilter fields).
     */
    ...
    /**
     * Load a single WebhooksFilter.
     *
     * @param WebhooksFilterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksFilterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksFilter|array The loaded WebhooksFilter as an assoc-array at the
    ...
    /**
     * Create a new WebhooksFilter.
     *
     * @param WebhooksFilterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksFilterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksFilter|array The created WebhooksFilter as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
