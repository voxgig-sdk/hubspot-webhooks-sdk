...
class WebhooksBatchResponseSubscriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_batch_response_subscription";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksBatchResponseSubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksBatchResponseSubscription|array $args WebhooksBatchResponseSubscription data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksBatchResponseSubscription|array The current WebhooksBatchResponseSubscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksBatchResponseSubscription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksBatchResponseSubscription fields).
     */
    ...
    /**
     * Create a new WebhooksBatchResponseSubscription.
     *
     * @param WebhooksBatchResponseSubscriptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksBatchResponseSubscriptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksBatchResponseSubscription|array The created WebhooksBatchResponseSubscription as an assoc-array at the
