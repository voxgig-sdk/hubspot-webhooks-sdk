...
// HubspotWebhooks SDK WebhooksSubscriptionResponse1 entity
...
class WebhooksSubscriptionResponse1Entity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_subscription_response_1";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksSubscriptionResponse1Entity($this->_client, $opts);
    }

    /**
     * @param WebhooksSubscriptionResponse1|array $args WebhooksSubscriptionResponse1 data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksSubscriptionResponse1|array The current WebhooksSubscriptionResponse1 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksSubscriptionResponse1 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksSubscriptionResponse1 fields).
     */
    ...
    /**
     * Load a single WebhooksSubscriptionResponse1.
     *
     * @param WebhooksSubscriptionResponse1LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksSubscriptionResponse1LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscriptionResponse1|array The loaded WebhooksSubscriptionResponse1 as an assoc-array at the
    ...
    /**
     * Create a new WebhooksSubscriptionResponse1.
     *
     * @param WebhooksSubscriptionResponse1CreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksSubscriptionResponse1CreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscriptionResponse1|array The created WebhooksSubscriptionResponse1 as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
