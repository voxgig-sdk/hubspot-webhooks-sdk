...
class WebhooksCollectionResponseSubscriptionResponseNoPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_collection_response_subscription_response_no_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksCollectionResponseSubscriptionResponseNoPagingEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksCollectionResponseSubscriptionResponseNoPaging|array $args WebhooksCollectionResponseSubscriptionResponseNoPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksCollectionResponseSubscriptionResponseNoPaging|array The current WebhooksCollectionResponseSubscriptionResponseNoPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksCollectionResponseSubscriptionResponseNoPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksCollectionResponseSubscriptionResponseNoPaging fields).
     */
    ...
    /**
     * List WebhooksCollectionResponseSubscriptionResponseNoPaging items matching the given filter.
     *
     * @param WebhooksCollectionResponseSubscriptionResponseNoPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of WebhooksCollectionResponseSubscriptionResponseNoPaging fields) as an assoc-array; WebhooksCollectionResponseSubscriptionResponseNoPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksCollectionResponseSubscriptionResponseNoPaging[]|array A list of WebhooksCollectionResponseSubscriptionResponseNoPaging items as assoc-arrays at
