...
// HubspotWebhooks SDK WebhooksSubscription entity
...
class WebhooksSubscriptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_subscription";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksSubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksSubscription|array $args WebhooksSubscription data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = HubspotWebhooksHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return WebhooksSubscription|array The current WebhooksSubscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksSubscription fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = HubspotWebhooksHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of WebhooksSubscription fields).
     */
    ...
    /**
     * Load a single WebhooksSubscription.
     *
     * @param WebhooksSubscriptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksSubscriptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscription|array The loaded WebhooksSubscription as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = HubspotWebhooksHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * Create a new WebhooksSubscription.
     *
     * @param WebhooksSubscriptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksSubscriptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscription|array The created WebhooksSubscription as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing WebhooksSubscription.
     *
     * @param WebhooksSubscriptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksSubscriptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscription|array The updated WebhooksSubscription as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
