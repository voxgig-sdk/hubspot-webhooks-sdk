...
class WebhooksSubscriptionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_subscription_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksSubscriptionListEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksSubscriptionList|array $args WebhooksSubscriptionList data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksSubscriptionList|array The current WebhooksSubscriptionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksSubscriptionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksSubscriptionList fields).
     */
    ...
    /**
     * List WebhooksSubscriptionList items matching the given filter.
     *
     * @param WebhooksSubscriptionListListMatch|array|null $reqmatch Match filter (any subset
     *   of WebhooksSubscriptionList fields) as an assoc-array; WebhooksSubscriptionListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSubscriptionList[]|array A list of WebhooksSubscriptionList items as assoc-arrays at
