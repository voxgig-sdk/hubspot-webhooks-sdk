...
// HubspotWebhooks SDK WebhooksSetting entity
...
class WebhooksSettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksSettingEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksSetting|array $args WebhooksSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksSetting|array The current WebhooksSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksSetting fields).
     */
    ...
    /**
     * Load a single WebhooksSetting.
     *
     * @param WebhooksSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebhooksSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSetting|array The loaded WebhooksSetting as an assoc-array at the
    ...
    /**
     * Update an existing WebhooksSetting.
     *
     * @param WebhooksSettingUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksSettingUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksSetting|array The updated WebhooksSetting as an assoc-array at the
     *   SDK boundary; throws HubspotWebhooksError on failure (item-5 convention).
     */
