...
class WebhooksCrmObjectSnapshotBatchEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "webhooks_crm_object_snapshot_batch";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WebhooksCrmObjectSnapshotBatchEntity($this->_client, $opts);
    }

    /**
     * @param WebhooksCrmObjectSnapshotBatch|array $args WebhooksCrmObjectSnapshotBatch data (assoc-array) to store.
     */
    ...
    /**
     * @return WebhooksCrmObjectSnapshotBatch|array The current WebhooksCrmObjectSnapshotBatch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebhooksCrmObjectSnapshotBatch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebhooksCrmObjectSnapshotBatch fields).
     */
    ...
    /**
     * Create a new WebhooksCrmObjectSnapshotBatch.
     *
     * @param WebhooksCrmObjectSnapshotBatchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WebhooksCrmObjectSnapshotBatchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebhooksCrmObjectSnapshotBatch|array The created WebhooksCrmObjectSnapshotBatch as an assoc-array at the
