...
// HubspotWebhooks SDK timeout feature
...
class HubspotWebhooksTimeoutFeature extends HubspotWebhooksBaseFeature
{
    ...
    private function _with_timeout(HubspotWebhooksContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HubspotWebhooksContext $_ctx, float $ms): void
    {
        $client = $this->client;
