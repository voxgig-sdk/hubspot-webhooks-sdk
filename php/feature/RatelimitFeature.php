...
// HubspotWebhooks SDK ratelimit feature
...
class HubspotWebhooksRatelimitFeature extends HubspotWebhooksBaseFeature
{
    ...
    private function _acquire(HubspotWebhooksContext $ctx): void
    {
    ...
    private function _track(HubspotWebhooksContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
