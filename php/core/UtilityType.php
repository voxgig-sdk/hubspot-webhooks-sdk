...
// HubspotWebhooks SDK utility type

class HubspotWebhooksUtility
{
    ...
    public static function copy(HubspotWebhooksUtility $src): HubspotWebhooksUtility
    {
        $u = new HubspotWebhooksUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
