...
// HubspotWebhooks SDK utility: fetcher

class HubspotWebhooksFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HubspotWebhooksSDK/1.0)';
    ...
    public static function call(HubspotWebhooksContext $ctx, string $fullurl, array $fetchdef): array
    {
