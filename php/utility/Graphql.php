...
// HubspotWebhooks SDK utility: graphql
//
...
class HubspotWebhooksGraphql
{
    ...
    // equivalent.
    public static function body(HubspotWebhooksContext $ctx): mixed
    {
    ...
    public static function errors(HubspotWebhooksContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
