...
// HubspotWebhooks SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HubspotWebhooksMakeRequest
{
    public static function call(HubspotWebhooksContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HubspotWebhooksResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HubspotWebhooksResponse($fetched);
        } else {
