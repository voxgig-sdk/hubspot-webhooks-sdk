...
// HubspotWebhooks SDK utility: make_options

class HubspotWebhooksMakeOptions
{
    ...
    public static function call(HubspotWebhooksContext $ctx): array
    {
        ...
        //
        // `HubspotWebhooksSchema::optspec()` is built from the model:
        ...
        $optspec = HubspotWebhooksSchema::optspec();
